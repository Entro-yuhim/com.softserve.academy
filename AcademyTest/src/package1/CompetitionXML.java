...
public class CompetitionXML extends DefaultHandler {
	...
	public Competition processXML(File f) throws Exception {
		String diffty = null;
		String name = null;
		String descr = null;
	...
	public void createXML(File file, Competition c) {
		...
		try {
			...
			for (Problem problem : problems) {
				...
				writer.writeAttribute("id", new Integer(problem.getId()).toString());				
